...
<div class="col-md-8 mx-auto  rounded p-4">
        ...
        <hr class="my-1">
        <form action="advertiserblistsearch.php" method="post" class="p-3">
...
<div class="col-md-8 mx-auto  rounded p-4">
        ...
        <div class="form-group">
        <input type="text" name="blacklist" class="form-control" value="<?php echo $blacklist;?>" placeholder="E.g. XYZ Company, This company arrears my 3 months salary."> 
        </div>
        <div class="form-group">
        <?php
            if($update == true):
            ...
            <?php else: ?>
            <button type="submit" class="btn btn-primary" name="adverstisersubmitblacklist">Submit</button> 
            <?php endif; ?>
