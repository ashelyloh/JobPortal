...
<div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="loginjobseeker.php">Job Seeker</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="loginadvertiser.php">Advertiser</a>
        </div>
        </li>
        <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="registerjobseeker.php">Job Seeker</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="registeradvertiser.php">Advertiser</a>
        </div>
        </li>	
	</ul>
</div>                
