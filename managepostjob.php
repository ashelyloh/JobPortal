...
<?php require_once 'server.php'; ?>
    ...
    <?php 
        ...
        //pre_r($result);
        ?>
        <p style="font-size:20px; color:green;">Manage Job Post:</p><br>
        ...
        <?php
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="managepostjob.php?editpostjob=<?php echo $row['ID']; ?>"
                            class="btn btn-info">Edit</a>
                            <a href="managepostjob.php?deletepostjob=<?php echo $row['ID']; ?>"
        ...
        function pre_r( $array ){
            ...
            echo '</pre>';}
    ?>
    <p style="font-size:20px; color:green;">Edit Job Post Details:</p><br>
    <div >
    <form action="managepostjob.php" method="POST">
        
        <input type="hidden" name="ID3" value="<?php echo $ID3; ?>">
        <div class="form-group">
        <label>Advertiser Username</label>
        <input type="text" name="Username2" value="<?php echo $Username2;?>" class="form-control" placeholder="Enter your username">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <?php
            if($updatepostjob == true):
            ?>
            <button type="submit" class="btn btn-info" name="updatepostjob">Update</button>
